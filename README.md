...
* **Задача**: выстроить систему аналитики: систему дашбордов, первые исследования и шаблоны анализа retention, ad-hoc гипотез, провести A/B тесты, автоматизировать рутинные задачи, подсчет основных метрик и отчетность.
